  ...
  shiny::navbarPage(
    ...
    shiny::tabPanel(
      ...
      shiny::conditionalPanel(
        condition = "output.option_on_off == true",
        shiny::wellPanel(
          style = paste0(
            "background-color: #fafafa; border-color: black; border: 5px; border-radius: 5px;"
          ),
          shiny::fluidRow(
            shiny::column(
              3,
            ...
            shiny::column(
              ...
              shiny::conditionalPanel(
                ...
                shiny::fluidRow(
                  shiny::column(10, shiny::uiOutput("select_targetVariable")),
                  shiny::column(
                    2,
                    helpTextDropdownButton(
                      id = "dropdown_target",
                  ...
                  shiny::column(12, shiny::uiOutput("targetVariable_check"))
                )
              ),
              shiny::fluidRow(
                shiny::conditionalPanel(
                  condition = "output.data_flag == true",
                  shiny::column(10, shiny::uiOutput("select_Factors")),
                  shiny::column(
                    2,
                    helpTextDropdownButton(
                      id = "dropdown_factors",
                  ...
                  shiny::column(12, shiny::uiOutput("selectFactors_check")),
                  shiny::fluidRow(
                    shiny::column(
                      12,
                      offset = 2,
                      shiny::conditionalPanel(
                        condition = "output.target_and_factors_flag == true",
                        shiny::actionButton(
                          inputId = "submit",
                          label = "Submit",
                          icon = icon("refresh")
            ...
            shiny::conditionalPanel(
              condition = "output.settings_flag == true",
              shiny::column(
                3,
                shiny::fluidRow(
                  shiny::column(
                  ...
                  shiny::conditionalPanel(
                    condition = "input.pattern_choice == 'manual'",
                    shiny::column(
                      10,
                      shiny::fluidRow(
                        shiny::column(1, shiny::div(id = "placeholder1")),
                        shiny::column(1, shiny::div(id = "placeholder2")),
                        shiny::column(1, shiny::div(id = "placeholder3")),
                        shiny::column(1, shiny::div(id = "placeholder4")),
                        shiny::column(1, shiny::div(id = "placeholder5")),
                        shiny::column(1, shiny::div(id = "placeholder6")),
                        shiny::column(1, shiny::div(id = "placeholder7")),
                        shiny::column(1, shiny::div(id = "placeholder8")),
                        shiny::column(1, shiny::div(id = "placeholder9")),
                        shiny::column(1, shiny::div(id = "placeholder10")),
                        shiny::column(1, shiny::div(id = "placeholder11")),
                        shiny::column(1, shiny::div(id = "placeholder12"))
                      )
                    ) #,
                    # shiny::column(2,
                    #    helpTextDropdownButton(
                ...
                shiny::fluidRow(
                  shiny::column(
                    ...
                    shiny::numericInput(
                      inputId = "delta",
                      label = HTML(
                        "<p style = 'color: orange;'>&delta; (clinically relevant effect size):</p>"
                      ),
                      value = 0.1,
                      min = 0,
                      step = 0.1
              ...
              shiny::column(
                ...
                shiny::fluidRow(
                  shiny::conditionalPanel(
                    condition = "input.alpha_method == 'Weighted Mean'",
                    shiny::column(
                      10,
                      shiny::fluidRow(
                        shiny::column(4, shiny::div(id = "place_holder1")),
                        shiny::column(4, shiny::div(id = "place_holder2")),
                        shiny::column(4, shiny::div(id = "place_holder3")),
                        shiny::column(4, shiny::div(id = "place_holder4")),
                        shiny::column(4, shiny::div(id = "place_holder5")),
                        shiny::column(4, shiny::div(id = "place_holder6")),
                        shiny::column(4, shiny::div(id = "place_holder7")),
                        shiny::column(4, shiny::div(id = "place_holder8")),
                        shiny::column(4, shiny::div(id = "place_holder9")),
                        shiny::column(4, shiny::div(id = "place_holder10")),
                        shiny::column(4, shiny::div(id = "place_holder11")),
                        shiny::column(4, shiny::div(id = "place_holder12"))
                      )
                    ) #,
                    #   shiny::column(2,
                    #      helpTextDropdownButton(
      ...
      shiny::conditionalPanel(
        condition = "output.settings_flag == false",
        HTML(
          paste0(
      ...
      shiny::conditionalPanel(
        ...
        shiny::fluidRow(
          shiny::conditionalPanel(
            condition = "output.table_on_off == true",
            shiny::column(
              4,
              shiny::wellPanel(
                style = paste0(
          ...
          shiny::conditionalPanel(
            condition = "output.graph_on_off == true",
            shiny::column(
              8,
              shiny::wellPanel(
                style = paste0(
                ...
                shiny::conditionalPanel(
                  ...
                  shiny::fluidRow(
                    shiny::column(
                      ...
                      conditionalPanel(
                        condition = "input.perform_permutation == true",
                        shiny::plotOutput(
                          "graphic_histogram",
                          width = "100%"
                        )
                    ...
                    shiny::column(
                      ...
                      shinyWidgets::materialSwitch(
                        ...
                        label = HTML(paste(
                          "<p style = 'color:black;'> Overall Mean"
                        )),
                        status = "default",
                        right = TRUE,
                        value = TRUE
                      ...
                      shinyWidgets::materialSwitch(
                        ...
                        label = HTML(paste0(
                          "<p style = 'color:#1e90ffe2'> Subgroup Mean </p>"
                        )),
                        status = "primary",
                        right = TRUE,
                        value = TRUE
                      ...
                      shinyWidgets::materialSwitch(
                        ...
                        label = HTML(paste0(
                          "<p style = 'color:#08cf86'> Complement Mean </p>"
                        )),
                        status = "success",
                        right = TRUE,
                        value = TRUE
                      ...
                      shinyWidgets::materialSwitch(
                        ...
                        label = HTML(paste0(
                          "<p style = 'color:#f5aa20'> Show background(s) for the truth values </p>"
                        )),
                        value = TRUE,
                        right = TRUE,
                        status = "warning"
                      ...
                      shinyWidgets::materialSwitch(
                        ...
                        label = HTML(paste0(
                          "<p style = 'color:#424242'> Show all other subgroup level(s) </p>"
                        )),
                        value = FALSE,
                        status = "info",
                        right = TRUE
                    ...
                    shiny::column(
                      12,
                      tagList(
                        shiny::column(2, shiny::uiOutput("lower_y")),
                        shiny::column(2, shiny::uiOutput("upper_y")),
                        shiny::checkboxInput(
                          inputId = "add_points",
                          label = HTML(paste0(
                            "<p style = 'color:#424242'> Add points to graph</p>"
                          )),
                          value = TRUE
                        ),
                        shiny::conditionalPanel(
                          ...
                          shiny::checkboxInput(
                            inputId = "add_jitter",
                            label = HTML(paste0(
                              "<p style = 'color:#424242'> Jitter points </p>"
                            )),
                            value = TRUE
                          )
                        ),
                        shiny::conditionalPanel(
                          ...
                          shiny::checkboxInput(
                            ...
                            label = HTML(paste0(
                              "<p style = 'color:#424242'> Add permuted subgroup means to graph</p>"
                            )),
                            value = FALSE
                          )
                        )
